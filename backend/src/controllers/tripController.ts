...
const validateHotelOptions = (hotels: any) => {
...
export const getTripById = async (req: any, res: any) => {
  try {
    const { id } = req.params;
...
export const savedTrip = async (req: any, res: any) => {
  try {
    if (!req.user?._id) {
...
export const getTripHistory = async (req: any, res: any) => {
  try {
